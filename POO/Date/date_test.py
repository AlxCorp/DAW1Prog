...
class TestDate(unittest.TestCase):
    ...
    def test_leap(self):
        self.assertFalse(self.date1.leap)
        self.assertFalse(self.date2.leap)
        new_date1 = Date(1, 1, 2000)
        new_date2 = Date(1, 1, 2004)
        new_date3 = Date(1, 1, 2100)
        self.assertTrue(new_date1.leap)
        self.assertTrue(new_date2.leap)
        self.assertFalse(new_date3.leap)
