"""
EN: Tool that allows the release of a killed port by the process that uses it.
ES: Herramienta que permite liberar un puerto matado el proceso que lo utiliza.
